...
class GenericAssistant(IAssistant):
    ...
    def train_model(self):
        ...
        self.hist = self.model.fit(np.array(train_x), np.array(train_y), epochs=3000, batch_size=10, verbose=1)
    ...
    def request(self, message):
        ...
        ##print('ints - ',ints) ---> [{'intent': 'no_in_range', 'probability': '0.001'}]

        try:
            if ints[0]['intent'] in self.intent_methods.keys():
                self.intent_methods[ints[0]['intent']]()

                return self._get_response(ints, self.intents) , [ ints[0]['intent'],ints[0]['probability'] ]
            ...
            # no_understand = "what !, I don't understand? Please tell me your question a little bit in detail also your topic should be about train tickets :)"

            no_understand ="no_in_range"

            return no_understand , ["no_in_range" , "0.00"]
